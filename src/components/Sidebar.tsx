    ...
    return (
        <div className="sidebar fixed h-full w-4/5 bg-white transition-all duration-300 z-50 transform -translate-x-full">
            <div className="sidebar-menu flex flex-col justify-center pl-8 bg-primary h-1/2">
                <a href="/#layanan" onClick={() => openSidebarHandler()}>
                    Layanan
                </a>
                <a href="/#harga" onClick={() => openSidebarHandler()}>
                    Harga
                </a>
                <a href="/#pembayaran" onClick={() => openSidebarHandler()}>
                    Pembayaran
                </a>
                <a href="/#mitra" onClick={() => openSidebarHandler()}>
                    Mitra
                </a>
                <a href="https://alinamed.com/blog/" rel="noopener noreferrer">
                    Artikel
                </a>
            </div>
